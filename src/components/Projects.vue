...
<template>
    <div id="projects">
        ...
        <div class="list">
            ...
            <ProjectCard mark="gold" title="RipGVC" desc="GitHub profile visitor counter" repo="ripgvc" prog="Rust" />
            <ProjectCard mark="" title="Jel" desc="Flexible, memory-safe, easy-to-use, interpreted programming language" repo="jel" prog="Rust" />
            ...
            <ProjectCard mark="" title="Totify" desc="Lightweight notification creator for browser" repo="totift" prog="TS" />
        </div>
    </div>
</template>
